...
public class TerritoryHover extends UIElement {
    ...
    public void paint(Graphics2D g2d) {
        ...
        g2d.setColor(DefaultDesigns.BACKGROUND_COLOR);
        g2d.fill(this.getElementShape());

        //set to correct color:
        g2d.setColor(DefaultDesigns.TEXT_COLOR);
        ...
        g2d.setColor(DefaultDesigns.BORDER_COLOR);
    ...
    public void moveTo(int x,int y) {
        if( x + this.getElementShape().getBounds().width  > GameWindow.WINDOW_WIDTH -15 )
            x = x - this.getElementShape().getBounds().width - 10;
        if( y + this.getElementShape().getBounds().height  > GameWindow.WINDOW_HEIGHT -15 )
